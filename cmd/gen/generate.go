...
func connectDB(cfg *conf.Data_Database) *gorm.DB {
	if cfg == nil {
		panic(errors.New(404, "GEN: connect db fail", "GEN: database config is nil"))
	}
	...
	panic(errors.New(404, "GEN: unsupported database driver", "GEN: unsupported database driver"))
}
...
func main() {
	...
	g := gen.NewGenerator(gen.Config{
		...
		FieldNullable: true, // 允许字段为空，例如deleted_at
	})
